...
public class LinksSlide : SlideContent
{
    ...
    public LinksSlide(string codeUrl){
    ...
    public override string PrintSlideHtml()
    {
        return $@"              <section>
					...
					<p class=""indent""><small>How do I get the code from GitHub?  See: <a href=""https://bobtabor.com/git"">https://bobtabor.com/git</a></small></p>
